      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 md:py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="flex flex-col space-y-4">
            <Link to="/home" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-gray-900">Zona de juegos</span>
            </Link>
            <p className="text-sm text-gray-600">
              Vive una experiencia de juego al siguiente nivel con nuestros
              títulos de vanguardia y mundos inmersivos.
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-6">
          <p className="text-center text-xs text-gray-500">
            © {new Date().getFullYear()} GameZone. Todos los derechos
            reservados.
          </p>
        </div>
      </div>
